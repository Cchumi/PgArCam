...
import { AppRegistry, Text, View, TouchableOpacity,TouchableHighlight, StyleSheet, Platform, Button, Image,Dimensions } from 'react-native'
    	...
    	<View style={styles.containers} >
			<View style={styles.container} >
				<View style={styles.background} >
        			<Image style={styles.image} source={require('./res/img/moi.jpg')} />
      			</View>
      		</View>
